...
fp_success = open("/var/log/compress_success.log", 'w')
fp_error = open("/var/log/compress_error.log", 'w')
...
def getFiles(root_path, above_size, below_size, quality, compress_flag):
	"""
